...
"""
	This is written by Zhiyang Ong to reformat an embedded list of topics and subtopics from the following conferences, and similar conferences:
	+ ICML.
	+ ICCV/ECCV.
	+ NeurIPS.
	+ CVPR.
...
input_file = "/Users/zhiyang/Documents/ricerca/saag-bibtex/outputs/scripts/input-files/topics.md"
# Absolute path to the output file.
output_file = "/Users/zhiyang/Documents/ricerca/saag-bibtex/outputs/scripts/output-files/topics-reformatted.md"
...
"""
	Create an output file object to write to the output file.
	+ \cite{Rungta2021}
"""
op_file_obj = open(output_file, "w+")
