...
print("a is:",a,"=")
"""
	Uncomment the next line if elements in the list have
		different occurring frequencies.
"""
...
"""
	It does not produce a list of keyphrases based on its frequency
		in the list.
	It does not determine the frequency per keyphrase.
"""
print("Method 1.")
...
"""
	Method cannot work for a list/set, because it works for
		a set of sets, or list of lists, or container of
		containers.
...
"""
	Solution only finds the mode, or keyphrase that occurs with
...
"""
	This solution works, but is not visually appealing.
	It produces a list of keyphrases based on its frequency in
		the list.
	It does not determine the frequency per keyphrase.
"""
...
print("res is:",res,"=")
"""
	This solution works, and produces a list of keyphrases
		and their corresponding frequency in order of
		appearance.
	Process frequency and keyphrase separately.
"""
...
"""
	This solution works, and produces a list of keyphrases
		in ascending order of frequency but in random order
		for each frequency.
	Process frequency and keyphrase separately.
"""
...
"""
	This solution works, and produces a list of keyphrases
		in descending order of frequency but in random order
		for each frequency.
	Process frequency and keyphrase separately.
"""
...
"""
	This solution works, and produces a list of keyphrases
		in descending order of frequency but in reverse
		lexicographical order for each frequency.
	Process frequency and keyphrase as a tuple.
